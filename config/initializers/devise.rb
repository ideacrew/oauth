...
Devise.setup do |config|
  ...
  # config.secret_key = 'a0c085d6938cacbaf2383bcc869d730e51679f761fd7d174c03d888e1bd69aa4155189e2df175eda47f46034635f6705a40545ce71cfb521ea5e3c5aa2fc3a40'
  ...
  # config.pepper = '6511ab7be7142433550172b23cdad5e0eaf76a96928321bfaefa08d04a9eec64b27e70dd0898ef5f7e757c98ade738d75f328795077e4c8529868aef417d7673'
  ...
  {
    # With Devise use :openid_connect name, or Devise will route to 'accounts/auth/:provider' rather
    # than 'accounts/auth/openid_connect'
    name: 'openid_connect',
    # Some OpenID Connect providers require the scope attribute in requests to the token endpoint, even
    # if this is not in the protocol specifications. In those cases, the send_scope_to_token_endpoint
    # property can be used to add the attribute to the token request. Initial value is true, which means
    # that the scope attribute is included by default
    # send_scope_to_token_endpoint: false,
    # scope: [:openid] tells the Provider we want to use OpenID Connect and find out how the account
    ...
    response_type: :code,
    # nonce is optional. If don't want to pass "nonce" parameter to provider, You should specify false to
    # send_nonce option. (default true)
    # send_nonce: true,
