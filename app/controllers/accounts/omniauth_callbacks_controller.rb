...
#  "info"=>{"name"=>"guest guest", "email"=>"guest@guest.com", "email_verified"=>false, "nickname"=>"guest", "first_name"=>"guest", "last_name"=>"guest", "gender"=>nil, "image"=>nil, "phone"=>nil, "urls"=>{"website"=>nil}},
#  "credentials"=>
#   {"id_token"=>
...
class Accounts::OmniauthCallbacksController < Devise::OmniauthCallbacksController
  ...
  def openid_connect
    ...
    identity = ::Identity.fetch_with_oidc(auth)
    sign_in_and_redirect identity.account
  end
